    ...
    <div className="about">
      ...
      <Row className="about__intro">
        <Col sm={6}>
          ...
          <p>
            Efektywny Altruizm to międzynarodowa społeczność szukająca
            odpowiedzi na to pytanie. Zdobytą tą drogą wiedzę wykorzystujemy
            później w praktyce, pracując na rzecz obszarów, które najbardziej
            potrzebują naszej pomocy. Okazuje się, że przy użyciu ograniczonych
            środków możemy mieć wpływ na realne zmiany na świecie.
          </p>
        </Col>
        <Col sm={6}></Col>
      </Row>
      ...
      <Row className="about__work">
        ...
        <Col sm={6}>
          ...
          <p>
            Fundacja Efektywny Altruizm to polska gałąź globalnego ruchu
            Effective Altruism.
          </p>
          <p>
          ...
          <p>
            <b>Szkolimy</b> z podstaw i dobrych praktyk efektywnej
            dobroczynności. W trakcie naszych spotkań szukamy odpowiedzi na
            trudne pytania. Przyglądamy się problemom filozoficznym, naukowym,
            jak i praktycznym aspektom czynienia dobra.
          </p>
          <p>
            <b>Łączymy ludzi i organizacje</b>. Tym pierwszym doradzamy w
            wyborze kariery lub celu darowizn w zgodzie z ich wartościami. Tym
            drugim pomagamy w pozyskaniu talentu i maksymalizacji ich
            korzystnego wpływu poprzez doradztwo.
          </p>
          <p>
