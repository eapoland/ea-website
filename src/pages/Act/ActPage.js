    ...
    <div className="act">
      ...
      <Row className="act__type" style={{ backgroundColor: "#edcf00" }}>
        ...
        <Col xs={12} md={6} className="act__type--desc">
          ...
          >
            <button className="btn ea-button" style={{ width: "12rem" }}>
              {content[0].cta}
            </button>
          </a>
        </Col>
      ...
      <Row className="act__type">
        <Col xs={12} md={6} className="act__type--desc">
          ...
          <a
            ...
            rel="noopener noreferrer"
          >
            <button className="btn ea-button" style={{ width: "11rem" }}>
              {content[1].cta}
            </button>
          </a>
        </Col>
          ...
          <Tabs defaultActiveKey="1" tabPosition={"left"}>
            <TabPane tab="Poznaj podstawy EA" key="1">
              <div>
                ...
                <p>
                  ...
                  kwestii, kilka nagrań wideo i lista książek, które przybliżą
                  Ci czym jest EA. Jeśli zastanawiasz się, na których obszarach
                  się skupić, zapoznaj się z narzędziem do priorytetyzacji i
                  profilami obiecujących obszarów. W serwisie Coursera, dostępny
                  jest darmowy kurs Petera Singera - wstęp do efektywnego
                  altruizmu.
                </p>
                <p>
                  ...
                  Alexa K. Chen na Quora. Jeśli otrzymasz dobre odpowiedzi,
                  które mogą przydać się innym członkom EA, zestaw je we wpisie
                  na blogu i udostępnij na EA Forum.
                </p>
                <p>
              ...
              <p>
                ...
                internetowe RSS, np Blogtrottr, dzięki którym otrzymasz mail,
                gdy pojawi się nowy wpis na EA Forum (RSS) lub na EA Blogs
                (RSS).
              </p>
              ...
              <p>
                ...
                Altruisto. Altruisto pozwala użytkownikom zbierać fundusze
                podczas zakupów online na najefektywniejsze organizacje
                charytatywne rekomendowane przez GiveWell, Animal Charity
                Evaluators i The Life You Can Save. Użytkownik nie ponosi
                żadnych dodatkowych kosztów za kupione produkty/usługi,
                Altruisto również nie śledzi aktywności online indywidualnych
                użytkowników. Więcej informacji i możliwość pobrania wtyczki na
                oficjalnej stronie:{" "}
                <a
              ...
              <p>
                Autorem wtyczki jest Daniel Wyrzykowski, jeden z doradców
                Fundacji Efektywny Altruizm.
              </p>
              ...
              <p>
                ...
                liście pozycji do przeczytania oraz wskazówkom podpartym
                badaniami naukowymi na stronie 80,000 Hours masz możesz
                realizować proces samodoskonalenia samodzielnie i bezpłatnie.
              </p>
            </TabPane>
            <TabPane tab="Rozwijaj obszar" key="2">
              ...
              <p>
                ...
                zarówno na przynoszenie korzyści innym, jak i praktykowanie
                swoich własnych umiejętności. W związku z tym, że przestrzeń EA
                jest w chwili obecnej stosunkowo młoda, każdy autor ma szansę
                przyczynić się do postępu w istotnej dziedzinie i rzucić nowe
                światło na pewne zagadnienia. Mimo, że zachęcamy wszystkich do
                krytycznego myślenia o tematach związanych z EA, taka aktywność
                najlepiej sprawdzi się w przypadku osób, które są dobrze
                zaznajomione z efektywnym altruizmem i/lub jego poszczególnymi
                obszarami.
              </p>
              ...
              <p>
                ...
                Jeśli chciałabyś/chciałbyś dowiedzieć się więcej na jakiś temat
                i podzielić się wiedzą z innymi, przeprowadź wywiad z
                odpowiednim ekspertem i udostępnij go szerszemu gronu. Eksperci
                mogą zapoznać Cię z wybraną dziedziną wiedzy lub problematyką i
                podzielić się doświadczeniem.
              </p>
              <h3>Weryfikuj opublikowane badania</h3>
              <p>
                Większość badań, które są przedmiotem zainteresowania
                efektywnych altruistów, jest nowa i przeprowadzona w
                ograniczonym zakresie, jeśli w ogóle. Aby podnieść standardy i
                jakość badań, jednostki i organizacje powinny przekazywać sobie
                nawzajem informacje zwrotne na temat sposobów myślenia i pracy.
                Dotyczy to weryfikowania prac publikowanych przez organizacje
                związane z EA, szczególnie, jeśli chodzi o pomoc potrzebującym i
                edukację: Czy prowadzone lekcje miały sens? Czy są jakieś
                kontrargumenty, które pominięto? Taka praca często wymaga
                budowania relacji z jednostkami i/lub organizacjami oraz
                gruntownej wiedzy na temat EA lub specyficznej dziedziny.
              </p>
              ...
              <p>
                ...
                korzystny wpływ poszczególnych działań niż jedno potwierdzające
                go badanie, są więc świetnym narzędziem dla osób chcących
                zmieniać świat na lepsze przy pomocy dowodów i rozumu. Podobnie
                jak the Cochrane Collaboration istnieje po to, by ewaluować i
                podsumowywać dowody wspierające najlepsze praktyki medyczne, tak
                również i efektywny altruizm mógłby skorzystać z
                przygotowywanych meta-analiz, np. na temat fortyfikacji i
                suplementacji jodem czy kalibracji.
              </p>
              ...
              <p>
                ...
                prawie każda organizacja EA musiała zawęzić swoje pole
                działania, żeby móc się lepiej skupić na swoich zadaniach, wiele
                spraw, które mogłyby być priorytetyzowane ze względu na skalę i
                rozwiązywalność, jest zaniedbywanych. Potrzebne są osoby gotowe
                do tego, by zejść z utartego szlaku i badać dziedziny, które
                zwykle znajdują się poza kompetencjami istniejących organizacji,
                aby poinformować sieć EA o tym, czy istnieją jakieś obszary,
                które powinny się znaleźć na liście priorytetów.
              </p>
              <h3>Staw czoła kluczowym problemom</h3>
              <p>
                W przypadku znalezienia odpowiedzi na pewne pytania, nasze
                przekonania na temat tego, na czym należy się skupiać, mogłyby
                się drastycznie zmienić. Skoncentrowanie swoich badań na
                kluczowych problemach mogłoby mieć zasadniczy wpływ w porównaniu
                do innych możliwości. Pytania o tym charakterze są z definicji
                istotne, a brak odpowiedzi na nie często wynika z trudnej,
                interdyscyplinarnej i/lub niepewnej natury problemów, których
                one dotykają. Stawienie czoła jednemu z nich jest świetnym
                projektem dla ambitnych badaczy, którzy są szczególnie
                entuzjastycznie nastawieni do przyczyniania się do globalnych
                zmian.
              </p>
            </TabPane>
            <TabPane tab="Wybierz karierę" key="3">
              ...
              <p>
                ...
                spędzać naprawdę dużo czasu, a pamiętaj, że Twój czas jest
                jednym z najlepszych zasobów, które mogą przyczynić się do
                czynienia różnicy na świecie. Znalezienie sposobu, w jaki
                spędzać ten czas w najkorzystniejszy sposób może być jednak
                naprawdę trudne.
              </p>
              ...
              <p>
                ...
                Chciałabyś/chciałbyś prowadzić badania, ale nie możesz znaleźć
                na to czasu? Jeśli tak, to jesteś doskonałym kandydatem do
                otrzymania grantu EA, nowej inicjatywy Centre for Effective
                Altruism mającej na celu wsparcie przedsiębiorczych altruistów w
                ich dążeniach do maksymalizacji dobra. Program grantowy jest
                otwarty dla wszystkich osób pełnoletnich i oferuje
                dofinansowania w wysokości nawet 100 000 funtów, jak również
                indywidualne porady w sprawie wyboru kariery udzielane przez
                doradcę z 80,000 Hours. Dodatkowymi atutami są prestiż i
                wsparcie, których prawdopodobnie nie gwarantowałoby indywidualne
              ...
              <p>
                ...
                się w przestrzeni EA i uważasz, że Twój pomysł jest naprawdę
                wart realizacji, spisz plan projektu i podziel się nim z
                ekspertami w danej dziedzinie lub na odpowiednich grupach EA na
                Facebooku, a następnie postaraj się go urzeczywistnić. Istnieje
                wiele{" "}
                <a
              ...
              <p>
                ...
                niewykorzystaną bazę darczyńców. Ludzie zwykle chcą przyczynić
                się do zmiany świata na lepsze, ale nie wiedzą, od czego zacząć.
                Możesz być ogniwem, które pomoże im przekuć ich chęci w
                praktykę. Poza tym, firmy zwykle prowadzą programy, które mogą
                nawet potroić ilość pieniędzy, która dotrze do organizacji.
              </p>
              <h3>
              ...
              <p>
                ...
                nie uzyskała jeszcze nawet swojej nazwy. Od tamtej pory
                zrobiliśmy bardzo duże postępy, ale jest jeszcze o wiele więcej
                rzeczy do zrobienia. Jeśli dołączasz do efektywnego altruizmu z
                doświadczeniem w dziedzinie, która jest niedostatecznie
                reprezentowana w społeczności (tj. większość dziedzin poza
                filozofią akademicką i informatyką), prawdopodobnie nie
                doszliśmy jeszcze do tego, jak najlepiej wykorzystać dorobek
                Twojej dyscypliny — a być może nie wiemy nawet, że może być ona
                przydatna dla EA.
              </p>
