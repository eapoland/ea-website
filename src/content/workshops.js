...
const hosts = {
  ...
  "mtischner": {
    ...
    "desc": "Poszukuje efektywnych sposobów na stworzenie bardziej zrównoważonej przyszłości żywności. Pracuje także dla ProVeg Polska, Too Good To Go i Targów Zero Waste. Dyrektor ds. rozwoju/współpracy Fundacji Efektywny Altruizm.",
    "photo": marcin
  },
  "mtruong": {
    "name": "Maria Gembarzewska-Truong",
    "desc": "Psycholożka, trenerka, HRowiec. Przyświeca jej jeden cel - tworzyć lepszy świat. Miłośniczka jogi, wycieczek górskich i zwierzęcej behawiorystyki. Dyrektorka ds. komunikacji Fundacji Efektywny Altruizm.",
    "photo": maria
  }
}
...
const workshops = [
  {
    ...
    "shortSummary": "Jak działać efektywnie w obszarze rzecznictwa w społecznie istotnych kwestiach?",
  ...
  },
  {
    ...
    "shortSummary": "Jak zapobiec kolejnej pandemii? Co z innymi zagrożeniami? Jak w nadchodzącej dekadzie zapobiec globalnym katastrofom?",
  ...
  },
  {
    ...
    "shortSummary": "Dobrostan zawodowy wpływa na to czy czujemy się w naszej pracy dobrze. Jak go osiągnąć?",
  ...
  },
  {
    ...
    "shortSummary": "Masz wyjątkowe możliwości, aby czynić dobro - dowiedz się w jaki sposób je zmaksymalizować!",
  ...
  },
  {
    ...
    "shortSummary": "Czy uważasz, że świat mógłby być lepszy? Czy chcesz mieć wpływ na jego pozytywną zmianę? Jak czynić dobro lepiej?",
